...
export default function Home() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(160deg, #1e0b3e 0%, #2d1458 50%, #1a0a30 100%)', minHeight: '90vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden', padding: '80px 24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }} className="hero-grid-1f">
            <div>
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                <a href="#contact" style={{ background: 'linear-gradient(135deg, #7c3aed, #a855f7)', color: '#fff', padding: '15px 32px', borderRadius: '10px', textDecoration: 'none', fontSize: '16px', fontWeight: '700', boxShadow: '0 8px 30px rgba(124,58,237,0.5)' }}>🚀 Demander un devis gratuit</a>
                <a href="tel:0320492900" style={{ background: 'transparent', color: '#c084fc', padding: '15px 32px', borderRadius: '10px', textDecoration: 'none', fontSize: '16px', fontWeight: '600', border: '2px solid rgba(124,58,237,0.5)' }}>📞 03 20 49 29 00</a>
              </div>
            </div>
      ...
      <section id="services" style={{ padding: '80px 24px', background: '#faf5ff' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            ...
            <p style={{ color: '#6b21a8', fontSize: '18px' }}>Tout ce dont votre entreprise a besoin, géré par un seul expert</p>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px' }}>
            {[
              ...
              <a key={s.href} href={s.href} style={{ textDecoration: 'none' }}>
                <div style={{ background: '#fff', borderRadius: '16px', padding: '32px 24px', border: '1px solid rgba(124,58,237,0.15)', boxShadow: '0 4px 20px rgba(124,58,237,0.08)', height: '100%' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px', marginBottom: '56px' }}>
            <div style={{ background: '#faf5ff', borderRadius: '20px', padding: '40px 32px', border: '2px solid rgba(124,58,237,0.2)' }}>
              ...
              <a href="#contact" style={{ display: 'block', textAlign: 'center', background: 'rgba(124,58,237,0.1)', color: '#7c3aed', padding: '14px', borderRadius: '10px', textDecoration: 'none', fontWeight: '700', marginTop: '28px', border: '2px solid rgba(124,58,237,0.3)' }}>Demander un devis</a>
            </div>
            <div style={{ background: 'linear-gradient(135deg, #1e0b3e, #2d1458)', borderRadius: '20px', padding: '40px 32px', border: '2px solid #7c3aed', position: 'relative' }}>
              ...
              <a href="#contact" style={{ display: 'block', textAlign: 'center', background: 'linear-gradient(135deg, #7c3aed, #a855f7)', color: '#fff', padding: '14px', borderRadius: '10px', textDecoration: 'none', fontWeight: '700', marginTop: '28px' }}>Demander un devis</a>
            </div>
          </div>
      ...
      <section id="contact" style={{ padding: '80px 24px', background: 'linear-gradient(135deg, #1e0b3e, #2d1458)' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{ color: '#c084fc', fontSize: '18px' }}>Réponse garantie sous 24h</p>
          </div>
          <div style={{ background: 'rgba(255,255,255,0.05)', borderRadius: '20px', padding: '48px', border: '1px solid rgba(124,58,237,0.3)' }}>
            {submitStatus && (
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '20px' }} className="form-grid-1f">
              <div><label style={{ display: 'block', color: '#c084fc', fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>Nom complet *</label><input type="text" name="name" value={formData.name} onChange={handleInputChange} required style={{ width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '8px', color: '#fff', fontSize: '14px', boxSizing: 'border-box' as const }} /></div>
              <div><label style={{ display: 'block', color: '#c084fc', fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>Email *</label><input type="email" name="email" value={formData.email} onChange={handleInputChange} required style={{ width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '8px', color: '#fff', fontSize: '14px', boxSizing: 'border-box' as const }} /></div>
              <div><label style={{ display: 'block', color: '#c084fc', fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>Entreprise *</label><input type="text" name="company" value={formData.company} onChange={handleInputChange} required style={{ width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '8px', color: '#fff', fontSize: '14px', boxSizing: 'border-box' as const }} /></div>
              <div><label style={{ display: 'block', color: '#c084fc', fontSize: '13px', fontWeight: '600', marginBottom: '8px' }}>Téléphone</label><input type="tel" name="phone" value={formData.phone} onChange={handleInputChange} style={{ width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '8px', color: '#fff', fontSize: '14px', boxSizing: 'border-box' as const }} /></div>
            </div>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <textarea name="message" value={formData.message} onChange={handleInputChange} required rows={5} style={{ width: '100%', padding: '12px 16px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(124,58,237,0.3)', borderRadius: '8px', color: '#fff', fontSize: '14px', resize: 'none', boxSizing: 'border-box' as const }} />
            </div>
            <button onClick={handleSubmit} disabled={isSubmitting} style={{ width: '100%', padding: '16px', background: isSubmitting ? 'rgba(124,58,237,0.5)' : 'linear-gradient(135deg, #7c3aed, #a855f7)', color: '#fff', border: 'none', borderRadius: '10px', fontSize: '16px', fontWeight: '700', cursor: isSubmitting ? 'not-allowed' : 'pointer' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', marginBottom: '40px' }}>
            ...
            <div>
              ...
              {['paris', 'lyon', 'marseille', 'toulouse', 'bordeaux', 'lille', 'nantes', 'strasbourg', 'montpellier', 'nice'].map(v => (
                <a key={v} href={`/telephonie-entreprise-${v}`} style={{ display: 'block', color: '#c084fc', fontSize: '13px', marginBottom: '6px', textDecoration: 'none', textTransform: 'capitalize' }}>{v}</a>
              ))}
            </div>
          </div>
